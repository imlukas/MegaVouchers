package dev.imlukas.megavouchers.util.menu.element.buttons.button;

import dev.imlukas.megavouchers.util.menu.element.MenuElement;
import dev.imlukas.megavouchers.util.runnables.AttachableConsumer;
...
public class Button implements MenuElement {
    ...
    @Override
    public Button copy() {
        return new Button(displayItem.clone(), clickTask, clickWithItemTask, placeholders);
    }
