package dev.imlukas.megavouchers.util.menu.mask;

import dev.imlukas.megavouchers.util.menu.selection.MultiSelection;
import dev.imlukas.megavouchers.util.menu.selection.PatternMaskSelection;
import dev.imlukas.megavouchers.util.menu.selection.Selection;
