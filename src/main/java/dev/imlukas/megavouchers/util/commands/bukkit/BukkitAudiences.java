package dev.imlukas.megavouchers.util.commands.bukkit;

import dev.imlukas.megavouchers.util.commands.audience.CommandAudience;
import dev.imlukas.megavouchers.util.commands.audience.bukkit.BukkitCommandSenderCommandAudience;
import dev.imlukas.megavouchers.util.commands.audience.bukkit.BukkitConsoleCommandAudience;
