package dev.imlukas.megavouchers.util.commands.manager;
...
import dev.imlukas.megavouchers.util.commands.data.CommandBuilder;
import dev.imlukas.megavouchers.util.commands.data.builder.SimpleCommandBuilder;
...
import dev.imlukas.megavouchers.util.commands.structure.CommandTree;
import dev.imlukas.megavouchers.util.commands.structure.CommandTree.TargetResult;
