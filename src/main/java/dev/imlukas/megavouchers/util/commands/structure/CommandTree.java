package dev.imlukas.megavouchers.util.commands.structure;

import dev.imlukas.megavouchers.util.commands.audience.CommandAudience;
import dev.imlukas.megavouchers.util.commands.context.CommandArgument;
import dev.imlukas.megavouchers.util.commands.context.CommandContext;
import dev.imlukas.megavouchers.util.commands.context.impl.MutatingCommandContext;
import dev.imlukas.megavouchers.util.commands.data.Command;
import dev.imlukas.megavouchers.util.commands.data.CommandHandler;
import dev.imlukas.megavouchers.util.commands.manager.AbstractCommandManager;
import dev.imlukas.megavouchers.util.commands.node.ArgumentCommandNode;
import dev.imlukas.megavouchers.util.commands.node.CommandNode;
