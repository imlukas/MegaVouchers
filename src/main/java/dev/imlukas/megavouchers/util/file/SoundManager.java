package dev.imlukas.megavouchers.util.file;
...
public class SoundManager extends YMLBase {
    ...
    private void playSound(Player player, String key, int volume, int pitch) {
        playSound(player, player.getLocation(), key, volume, pitch);
    }

    private void playSound(Player player, Location location, String key, int volume, int pitch) {
